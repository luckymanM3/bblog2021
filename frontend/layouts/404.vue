<template>
  <div class="bg-gray-100">
    ...
    >
      <svg
        class="w-full p-6 lg:p-64 fill-current text-gray-300"
        viewBox="0 0 445 202"
    ...
    <div
      class="h-screen w-screen flex flex-wrap justify-center content-end md:content-center items-end md:items-center relative z-10"
    >
      <div class="p-6 text-center ">
        <h2 class="uppercase text-xl lg:text-5xl font-black">
          We are sorry, Page not found!
        </h2>
        <p class="mt-3 uppercase text-sm lg:text-base text-gray-900">
          The page you are looking for might have been removed had its name
          changed or is temporarily unavailable.
        </p>
        <a
          href="/"
          class="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-2xl"
          >Back To Homepage</a
        >
      </div>
    </div>
